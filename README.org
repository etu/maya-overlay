...
Merge layman, edit the file: /etc/layman/layman.cfg and add "[[https://github.com/etu/maya-overlay/raw/master/overlay.xml][https://github.com/etu/maya-overlay/raw/master/overlay.xml]]" to the "overlays" part.
